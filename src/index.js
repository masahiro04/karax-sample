...
function applyEvents_603980035(n_603980036) {
  ...
  framePtr = F;
    ...
    Label1: do {
      ...
      F.line = 146;
      colontmp__436207723 = (n_603980036.events).length;
      F.line = 119;
      var i_436207724 = 0;
      Label2: do {
        F.line = 120;
  ...
  BeforeRet: do {
    ...
    break BeforeRet;
      ...
      Label1: do {
        ...
        Label2: do {
          ...
          F.line = 310;
          colontmp__436207709 = (n_603980064.kids).length;
          F.line = 119;
          var i_436207710 = 0;
          Label3: do {
            F.line = 120;
              ...
              if (!(i_436207710 < colontmp__436207709)) break Label4;
                ...
                F.line = 194;
                k_603980176 = n_603980064.kids[chckIndx(i_436207708, 0, (n_603980064.kids).length - 1)];
                F.line = 194;
    ...
    Label5: do {
      ...
      Label6: do {
        ...
        F.line = 313;
        colontmp__436207719 = subInt((n_603980064.attrs).length, 2);
        F.line = 65;
        var res_436207720 = 0;
        Label7: do {
          F.line = 66;
            ...
            if (!(res_436207720 <= colontmp__436207719)) break Label8;
              ...
              F.line = 205;
              k_603980177 = n_603980064.attrs[chckIndx(i_436207718, 0, (n_603980064.attrs).length - 1)];
              F.line = 205;
              v_603980178 = n_603980064.attrs[chckIndx(addInt(i_436207718, 1), 0, (n_603980064.attrs).length - 1)];
              if (!((v_603980178 == null))) {
              F.line = 207;
...
function same_603980217(n_603980218, e_603980219, nesting_603980220) {
  ...
  BeforeRet: do {
    ...
    Label3: do {
      ...
      F.line = 230;
      colontmp__436207731 = len_637534908(n_603980218);
      F.line = 119;
      var i_436207732 = 0;
      Label4: do {
        F.line = 120;
...
function eq_603980271(a_603980272, b_603980273, recursive_603980274) {
  ...
  BeforeRet: do {
    ...
    Label1: do {
      ...
      F.line = 276;
      colontmp__436207750 = len_637534908(a_603980272);
      F.line = 119;
      var i_436207751 = 0;
      Label2: do {
        F.line = 120;
    ...
    Label6: do {
      ...
      F.line = 308;
      colontmp__436207754 = len_637534908(a_603980272);
      F.line = 119;
      var i_436207755 = 0;
      Label7: do {
        F.line = 120;
  ...
  framePtr = F;
    ...
    Label1: do {
      ...
      Label2: do {
        ...
        F.line = 313;
        colontmp__436207768 = subInt((oldNode_603980363.attrs).length, 2);
        F.line = 65;
        var res_436207769 = 0;
        Label3: do {
          F.line = 66;
            ...
            if (!(res_436207769 <= colontmp__436207768)) break Label4;
              ...
              F.line = 327;
              k_603980368 = oldNode_603980363.attrs[chckIndx(i_436207767, 0, (oldNode_603980363.attrs).length - 1)];
              F.line = 327;
              __603980369 = oldNode_603980363.attrs[chckIndx(addInt(i_436207767, 1), 0, (oldNode_603980363.attrs).length - 1)];
              F.line = 327;
    ...
    Label5: do {
      ...
      Label6: do {
        ...
        F.line = 313;
        colontmp__436207774 = subInt((newNode_603980362.attrs).length, 2);
        F.line = 65;
        var res_436207775 = 0;
        Label7: do {
          F.line = 66;
            ...
            if (!(res_436207775 <= colontmp__436207774)) break Label8;
              ...
              F.line = 329;
              k_603980370 = newNode_603980362.attrs[chckIndx(i_436207773, 0, (newNode_603980362.attrs).length - 1)];
              F.line = 329;
              v_603980371 = newNode_603980362.attrs[chckIndx(addInt(i_436207773, 1), 0, (newNode_603980362.attrs).length - 1)];
              if (!((v_603980371 == null))) {
              F.line = 331;
...
function removeAllEventHandlers_603979893(d_603979894) {
  ...
  framePtr = F;
    ...
    Label1: do {
      ...
      F.line = 96;
      colontmp__436207782 = d_603979894.karaxEvents.length;
      F.line = 119;
      var i_436207783 = 0;
      Label2: do {
        F.line = 120;
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      Label8: do {
        ...
        F.line = 521;
        colontmp__436207737 = subInt(pos_603980581, 1);
        F.line = 90;
        var res_436207738 = commonPrefix_603980558;
        Label9: do {
          F.line = 91;
            Label10: while (true) {
            if (!(res_436207738 <= colontmp__436207737)) break Label10;
              F.line = 521;
              i_603980586 = res_436207738;
              F.line = 521;
      ...
      Label11: do {
        ...
        var i_603980591 = 0;
        F.line = 90;
        var res_436207741 = pos_603980581;
        Label12: do {
          F.line = 91;
            Label13: while (true) {
            if (!(res_436207741 <= newPos_603980568)) break Label13;
              F.line = 525;
              i_603980591 = res_436207741;
              F.line = 525;
        ...
        Label14: do {
          ...
          var i_603980597 = 0;
          F.line = 90;
          var res_436207744 = pos_603980581;
          Label15: do {
            F.line = 91;
              Label16: while (true) {
              if (!(res_436207744 <= newPos_603980568)) break Label16;
                F.line = 529;
                i_603980597 = res_436207744;
                F.line = 529;
      ...
      Label17: do {
        ...
        var i_603980602 = 0;
        F.line = 90;
        var res_436207747 = pos_603980581;
        Label18: do {
          F.line = 91;
            Label19: while (true) {
            if (!(res_436207747 <= oldPos_603980567)) break Label19;
              F.line = 532;
              i_603980602 = res_436207747;
              F.line = 532;
...
function moveDom_603980446(dest_603980447, src_603980448) {
  ...
  framePtr = F;
    ...
    Label1: do {
      ...
      F.line = 393;
      colontmp__436207793 = len_637534908(dest_603980447);
      F.line = 119;
      var i_436207794 = 0;
      Label2: do {
        F.line = 120;
  ...
  framePtr = F;
    Label1: do {
      ...
      Label2: do {
        F.line = 120;
          Label3: while (true) {
          if (!(i_436207787 < kxi_603980466.patchLen)) break Label3;
            F.line = 397;
            i_603980471 = i_436207787;
            F.line = 398;
    ...
    Label4: do {
      ...
      Label5: do {
        F.line = 120;
          Label6: while (true) {
          if (!(i_436207790 < kxi_603980466.patchLenV)) break Label6;
            F.line = 428;
            i_603980503 = i_436207790;
            F.line = 429;
...
function createDom_436207623() {
  ...
  var F = {procname: "index.createDom", prev: framePtr, filename: "/Users/masahirookubo/me/nim/karax-sample/karax_sample/src/index.nim", line: 0};
  framePtr = F;
    F.line = 4;
    F.line = 4;
    var tmp_436207655 = tree_637534986(44, []);
    F.line = 5;
    add_637534923(tmp_436207655, text_637535038(makeNimstrLit("Hellosss world")));
